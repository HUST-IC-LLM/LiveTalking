...
async def offer(request):
    ...
    if len(nerfreals) >= opt.max_session:
        ...
        return web.Response(
            ...
            text=json.dumps({"code": -1, "msg": "已达到最大会话数限制"}),
...
if __name__ == "__main__":
    ...
    # 添加Ollama相关参数
    parser.add_argument(
        "--llm_model", type=str, default="qwen3:32b", help="Ollama模型名称"
    )
    parser.add_argument(
        "--llm_url", type=str, default="http://localhost:11434", help="Ollama API地址"
    )
    ...
    parser.add_argument(
        "--ragflow_agent_id",
        type=str,
        default="a4cf97b82a3311f0b9a9529bb6126436",
        help="RAGFlow Agent ID",
    )
    ...
    if opt.model == "ernerf":
        from nerfreal import NeRFReal, load_avatar, load_model
