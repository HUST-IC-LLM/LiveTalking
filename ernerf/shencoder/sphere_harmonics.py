...
from torch.amp import custom_bwd as amp_custom_bwd, custom_fwd as amp_custom_fwd
...
class _sh_encoder(Function):
    @staticmethod
    @amp_custom_fwd(cast_inputs=torch.float32, device_type='cuda') # force float32 for better precision
    ...
    @staticmethod
    #@once_differentiable
    @amp_custom_bwd(device_type='cuda')
